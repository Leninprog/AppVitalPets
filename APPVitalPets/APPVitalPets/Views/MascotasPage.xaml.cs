...
public partial class MascotasPage : ContentPage
{
    ...
    private async void OnAgregarClicked(object sender, EventArgs e)
    {
        ...
        {
            await DisplayAlert("Error", "Por favor ingresa una edad válida (solo números).", "OK");
            return;
        }
    ...
    private async void OnEliminarMascota(object sender, EventArgs e)
    {
        ...
        var confirmacion = await DisplayAlert("Confirmar", $"¿Eliminar a {mascota.Nombre}?", "Sí", "No");
